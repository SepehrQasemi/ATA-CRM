...
## خروجی‌های اصلی
- صفحه اصلی عمومی (`/`) با معرفی محصول و CTA
- رابط چندزبانه کامل EN/FR/FA با RTL کامل برای فارسی
- مرکز راهنما (`/help`) شامل onboarding، FAQ و راهنمای نقش‌ها
- In-app tips و جستجوی سراسری سریع
